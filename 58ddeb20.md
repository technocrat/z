...
In `R` it helps to recall school algebra: $f(x) = y$, where the three objects (in `R`, *everthing* is an object, are
...
<sup>Created on 2020-12-20 by the [reprex package](https://reprex.tidyverse.org) (v0.3.0.9001)</sup>
...
This tells us that we cannot reject $H_0$, that the true difference of the means are the means is zero.
